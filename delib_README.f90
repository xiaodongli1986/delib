...
Then you can use a command like
	ifort test.f90 $delm
or equivalently
	ifort test.f90 -lde -I$demods
to compile f90 file with functions defined in delib.

Notice that -mkl option is necessary to use the SNLS3 function.
...
#################################################################		
	...
	PUBLIC :: de_chisq_snls3, de_chisq_union2p1
	
	!bao chisq functions
	PUBLIC :: de_chisq_6dFGS!, de_chisq_2dFGS
	PUBLIC :: de_chisq_SDSSDR7_old, de_chisq_SDSSDR7_new, de_chisq_BOSSDR9
	PUBLIC :: de_chisq_WigZ_rsDV, de_chisq_WigZ_A
	PUBLIC :: de_chisq_bao_ver1, de_chisq_bao_ver2
	
	!CMB chisq functions
	PUBLIC :: de_chisq_wmap7
